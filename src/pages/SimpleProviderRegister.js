...
const SimpleProviderRegister = () => {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-secondary-50 via-primary-50 to-accent-50 py-12 px-4">
                ...
                >
                    ...
                    <div className="bg-blue-50 border-2 border-blue-200 rounded-xl p-4 mb-6">
                        <p className="text-sm text-blue-800">
                            ✨ <strong>Just 4 fields!</strong> You can add cuisine, pricing, and location details later from your dashboard.
                        </p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
                        ...
                        {/* Submit */}
                        <Button type="submit" variant="secondary" className="w-full text-lg py-4" loading={loading}>
                    ...
                    <div className="mt-6 p-4 bg-yellow-50 rounded-xl">
                        <p className="text-sm text-gray-700">
                            <strong>After signup:</strong> Complete your profile with cuisine types, pricing, and location to start receiving connection requests.
                        </p>
                    </div>
                    ...
                    <div className="mt-6 pt-6 border-t border-gray-200 text-center">
                        <p className="text-gray-600 mb-2">Looking for tiffin service?</p>
                        <Link to="/tenant/register" className="text-primary-600 font-semibold hover:text-primary-700">
                            Register as Tenant →
                        </Link>
                    </div>
                </motion.div>
...
export default SimpleProviderRegister;
